...
HD_PWD='C:/Users/noahj/Documents/GitHub/WavGenA/WavGenA.runs/Top_Level_view_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Level_view_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Level_view_clk_wiz_1_0.tcl
